...
function checkScroll() {
    ...
    document.getElementById('currentTitleText').innerText = titleTexts[currentPage];
    document.getElementById('upperBar').style.height = `${barTotalHeight / (numPage - 1) * currentPage}vh`;
    document.getElementById('lowerBar').style.height = `${barTotalHeight / (numPage - 1) * (numPage - currentPage - 1)}vh`;
